...
class Store_Sales_Analysis(object):
    ...
    def __init__(self):
        ...
        self.competition_distance_scaler   = self.load_scaler('/Models/competition_distance_scaler')
        self.competition_time_month_scaler = self.load_scaler('/Models/competition_time_month_scaler')
        self.promo_time_week_scaler        = self.load_scaler('/Models/promo_time_week_scaler')
        self.year_scaler                   = self.load_scaler('/Models/year_scaler')
        self.store_type_scaler             = self.load_scaler('/Models/store_type_encoder')
